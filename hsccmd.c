...
BYTE c;
    ...
    if ( argc == 2 )
    {
        ...
        else
        {
            ...
            {
                WRMSG(HHC00136, "W", "hscmd.c 1", strerror(errno));
                ...
                if (IS_CPU_ONLINE(i))
                {
                    ...
                    if ( MLVL(VERBOSE) )
                    {
                        ...
                        if ( rc == 0 )
                            ...
                            WRMSG( HHC00136, "W", "hscmd.c 2", strerror(errno));
                            WRMSG( HHC00136, "W", "setpriority()", strerror(errno));
                    }
                }
            }
            ...
            for(;;)
            {
                ...
                if ( MLVL(VERBOSE) )
                {
                    if ( rc == 0 )
                        ...
                        WRMSG( HHC00136, "W", "hscmd.c 3", strerror(errno));
                        WRMSG( HHC00136, "W", "setpriority()", strerror(errno));
                }
                break;
            }
            ...
            for ( i = 0; tname[i] != NULL; i++ )
            {
                ...
                if ( MLVL(VERBOSE) )
                {
                    if ( rc == 0 )
                        ...
                        WRMSG( HHC00136, "W", "hscmd.c 4", strerror(errno));
                        WRMSG( HHC00136, "W", "setpriority()", strerror(errno));
                }
            }
