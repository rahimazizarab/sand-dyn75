...
/*
  ...
  R1  = Byte Counter
  R2  = Source/Destination of PC buffer.  32bits. (function: init,send)
...
static void tcpip_init () {
    ...
    fprintf  (stderr, "############  init  TCPIP ########### \n");
/*****return by rahim remove later************************************/
    return;
}
...
static void EZASOKET (long func, long aux1, long aux2, talk_ptr t) {
    ...
    case 16: /* GETSOCKNAME */
        ...
        i = t->len_out;
       /*   t->ret_cd =       */
       /*      getsockname (Ccom_han [aux1], (struct sockaddr *)(t->buffer_out),  (int *)(&i));    */ 
       /*  format   int getsockname(int sockfd, struct sockaddr *addr, socklen_t *addrlen);   */
...
long lar_tcpip (long * regs) {
    ...
    if (get_reg (regs, 0) == 0) { /* Initial call. */
           ...
           /* Alloc memory for this communication. */
            fprintf  (stderr, "22222222  LAR_TCPIP ### \n");
         ...
         { /* Alloc memory for this communication. */
            ...
            int ra = (int) (get_reg (regs, 7));
            fprintf  (stderr, "R7 : %d LAR_TCPIP   ### \n", ra);  
    ...
    fprintf  (stderr, "44444444  LAR_TCPIP ### \n");
    ...
    fprintf  (stderr, "555555  LAR_TCPIP ### \n");
            free (t->buffer_in);
